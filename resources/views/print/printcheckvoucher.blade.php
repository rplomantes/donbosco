<html>
	...
	<div id="footer">Page <span class="pagenum"></span></div>    
		...
		<tr valign="top"><td width="25%">Prepared By:<br><br><i>{{\Auth::user()->firstname}} {{\Auth::user()->middlename}} {{\Auth::user()->lastname}}</i></td><td width="25%">Checked By:</td><td width="25%">Approved By:</td><td width="25%">Received By:<div style="font-size: 10px;margin-top:25px;">SIGNATURE OVER PRINTED NAME</div></td></tr>
        </table>
        </body>
</html>
