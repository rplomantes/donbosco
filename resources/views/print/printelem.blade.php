            ...
            <tr>
                ...
                <table border = '1' cellspacing="0" cellpadding = "0" width="100%" class="reports">
                    ...
                    @foreach($grades as $grade)
                        @if($grade->subjecttype == 0)
                            <tr style="text-align: center;font-size: 8pt;">
                                ...
                                <td align="center">{{number_format(round($grade->final_grade,2),2)}}</td>
                                <td align="center">
                    ...
                    <tr style="text-align: center">
                        ...
                        <td align="center"><b>{{number_format(GradeController::gradeQuarterAve(array(0),array(0),1,$grades,$level),2)}}</b></td>
                        <td align="center"><b>{{number_format(GradeController::gradeQuarterAve(array(0),array(0),2,$grades,$level),2)}}</b></td>
                        <td align="center"><b>{{number_format(GradeController::gradeQuarterAve(array(0),array(0),3,$grades,$level),2)}}</b></td>
                        <td align="center"><b>{{number_format(GradeController::gradeQuarterAve(array(0),array(0),4,$grades,$level),2)}}</b></td>
                        <td align="center"><b>{{number_format(GradeController::gradeQuarterAve(array(0),array(0),5,$grades,$level),2)}}</b></td>
