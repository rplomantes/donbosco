...
<div class="container">
  ...
  <div id="searchbody">   
            ...
            <tr><th>Student Number</th><th>Student Name</th><th>Gender</th><th>View Grade</th></tr>        
            </thead>
            <tbody>
               
            @foreach($students as $student)
            <tr><td>{{$student->idno}}</td><td>{{$student->lastname}}, {{$student->firstname}} {{$student->middlename}}
                    {{$student->extensionname}}</td><td>{{$student->gender}}</td><td ><a href="{{url('seegrade',$student->idno)}}">View</a></td></tr>
            @endforeach
            </tbody>
            </table>
                 </div>
