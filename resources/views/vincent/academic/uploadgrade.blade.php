...
<div class="container">
    <div class="col-md-3">
        ...
        <form action="{{ URL::to('upload/grade') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!} 
    ...
    <div class="col-md-9">
        @if(isset($grades))
        <form id="form" onsubmit="return sub();" method="POST" action="{{url('/saveentry')}}" >
