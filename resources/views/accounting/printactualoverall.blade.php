<html>
   ...
   <hr>
    ...
    <tr><td>Total Actual Deposit</td><td>{{number_format($totalcbc + $totalbpi1 + $totalbpi2 + $totallandbank1 + $totallandbank2,2)}}</td></tr> 
    <tr><td>Difference</td><td>{{number_format($totalamount + $totalcheckamount-$totalcbc - $totalbpi1 - $totalbpi2 -  $totallandbank1 - $totallandbank2,2)}}</td></tr>
    </table>
