...
<div class="container-fluid">
    ...
    <div class="col-md-6">
             ...
             <table class="table table-responsive table-bordered">
               @if($mainbalance > 0 )
                <tr><td>Main Account<br>{{$mainbalance}}</td><td align="right"><input onkeypress = "validate(event)" type="number" step="any"  max="{{$mainbalance}}"  name="totaldue" id="totaldue" style="text-align:right" class="form-control"></td></tr>
               @else
