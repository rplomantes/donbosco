...
?>
<tr>
    <td colspan="{{$offices->count() + 6}}"><b>Personnel Expense:</b></td>
</tr>
@foreach($fields->where('type','personel_expense',false)->groupBy('group') as $group=>$sub_groups)
<!--With subgroup-->
...
?>
<tr align='right'>
    <td align='left' style="padding-left:60px">{{$sub_group->sub_group}}</td>
